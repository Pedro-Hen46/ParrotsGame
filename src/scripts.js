...
if (qtdCartas % 2 == 0 && qtdCartas >= 4 && qtdCartas <= 14) {
  ...
  alert(
    `Voce não escolheu um numero par dentro do intervalo, por favor tente novamente. Agora com um numero PAR entre o intervalo informado | 4 a 14 |.`
  );
  location.reload();
}
...
document.querySelector(
  ".qtd-cartas"
).innerText = `VOCÊ ESTA JOGANDO COM ${qtdCartas} CARTAS.`;

const cardBoard = document.querySelector(".cardboard");

let imagesCards = [
  "./lib/images/bobrossparrot.gif",
  "./lib/images/explodyparrot.gif",
  "./lib/images/fiestaparrot.gif",
  "./lib/images/metalparrot.gif",
  "./lib/images/revertitparrot.gif",
  "./lib/images/tripletsparrot.gif",
  "./lib/images/unicornparrot.gif",
  "./lib/images/bobrossparrot.gif",
  "./lib/images/explodyparrot.gif",
  "./lib/images/fiestaparrot.gif",
  "./lib/images/metalparrot.gif",
  ...
  for (let i = 0; i < qtdCartas; i++) {
    document.querySelector(".baralho").innerHTML += `
        <div class="memory-card" data-card="${imagesCards[carta[i]]}">
              ...
              <img class="front-face" src="./lib/images/front.png" width="97px" height="106px">      
...
function restartGame() {
  if (window.confirm("Deseja reiniciar o game?")) {
    location.reload();
  }
}
